...
/**
 * https://blog.csdn.net/w15558056319/article/details/123384164
 * 公平分发:消费者2处理一条消息200ms，消费者1处理需要1秒，因此，消费者2处理的消息明显比消费者1多的多，即所谓的能者多劳！
 * @author qiaoyanan
 * date:2022/10/19 16:04
 */
public class FairConsumerA implements Runnable {
